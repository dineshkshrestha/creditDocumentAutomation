...
@section('heading','Choose and Add Facilities')
@section('small_heading','Please select the Facilities')
@section('borrower')
            ...
            @if($loan)
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="padding-right: 12px"> {!! form::select('offerletter_year',['2000'=>'2000','2001'=>'2001',
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('corporate_facilities.edit',[$bid, $f->id])}}">
                                            <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                    </li>
                                    <li>
                                        <a href="">
                                            <form action="{{route('corporate_facilities.destroy',$f->id)}}"
                                                  method="post">
                                                {{csrf_field()}}
...
<th>Within</th>
    ...
    {!! Form::open(['route' =>'corporate_facilities.store','method'=>'post'],['class'=>'form-horizontal']) !!}
