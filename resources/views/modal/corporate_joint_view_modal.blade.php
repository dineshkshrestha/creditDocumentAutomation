    ...
    <div class="modal-dialog modal-lg" role="document">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title w-100" id="myModalLabel">All The Joint Property Owners for Corporate Borrower</h4>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="">
                                                    <form action="{{route('personal_property_join.remove',[$bid,$jid,$a->id])}}"
                                                          method="post">
                                                        {{csrf_field()}}
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="">
                                                    <form action="{{route('personal_property_join.remove',[$bid,$jid,$b->id])}}"
                                                          method="post">
                                                        {{csrf_field()}}
                                                        <input type="hidden" name="_method" value="delete">
                                                        <button type="submit" class="btn btn-default btn-xs"
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="">
                                                    <form action="{{route('personal_property_join.remove',[$bid,$jid,$c->id])}}"
                                                          method="post">
                                                        {{csrf_field()}}
                                                        <input type="hidden" name="_method" value="delete">
                                                        <button type="submit" class="btn btn-default btn-xs"
