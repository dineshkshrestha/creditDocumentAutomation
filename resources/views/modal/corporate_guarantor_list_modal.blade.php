                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            ...
                                            <a href="{{route('corporate_guarantor.edit',[$bid,$a->id])}}" class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Change Status</a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <form action="{{route('corporate_guarantor.destroy',[$bid,$a->id])}}" method="post">
                                                    {{csrf_field()}}
