                    ...
                    @foreach($personal_guarantor_list as $a)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class=" btn btn-primary btn-xs" href="{{route('corporate_property.personal_select',[$bid,$id])}}">
                    ...
                    @foreach($corporate_guarantor_list as $a)
                        <tr>
                            ...
                            <td>
                                ...
                                <a class=" btn btn-primary btn-xs" href="{{route('corporate_property.corporate_select',[$bid,$id])}}">
                                    <i class="fa  fa-square-o fa-fw"></i>Select as Property Owner</a>
