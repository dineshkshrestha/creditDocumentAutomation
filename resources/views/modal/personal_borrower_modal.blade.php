                    ...
                    <!-- /.box-header -->
                            ...
                            <tr>
                                ...
                                <td style="padding-right: 12px">  {!! form::select('issued_year',['1980'=>'1980','1981'=>'1981',
                                    ...
                                    @if($errors->has('issued_year'))
                                        <span class="label label-danger">{{$errors->first('issued_year')}} </span>
                                    @endif
                                </td>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td style="padding-right: 12px">  {!! form::label('father_relation','Relation with Borrower') !!}</td>
                            ...
                            <tr>
                                ...
                                <td style="padding-right: 12px">
                                    {!! form::select('father_relation',['%f]/f '=>'%f]/f ','%f]/L '=>'%f]/L '],'%f]/f ',['class'=>'form-control input-sm','id'=>'father-relation','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
