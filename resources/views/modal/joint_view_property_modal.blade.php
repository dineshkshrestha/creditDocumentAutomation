                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                ...
                                                <a href="{{route('joint_property.land_borrower_edit',[$bid,$a->id,'personal'])}}"
                                                   class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                            </li>
                                            <li>
                                                <a href="">
                                                    <form action="{{route('joint_property.land_borrower_destroy',[$bid,$a->id,'personal'])}}"
                                                          method="post">
                                                        {{csrf_field()}}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="{{route('joint_property.share_borrower_edit',[$bid,$a->id,'personal'])}}"
                                                       class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                                </li>
                                                <li>
                                                    <a href="">
                                                        <form action="{{route('joint_property.share_borrower_destroy',[$bid,$a->id,'personal'])}}"
                                                              method="post">
                                                            {{csrf_field()}}
                                                            <input type="hidden" name="_method" value="delete">
                                                            <button type="submit" class="btn btn-default btn-xs"
