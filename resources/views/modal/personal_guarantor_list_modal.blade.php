                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            ...
                                            <a href="{{route('personal_guarantor.edit',[$bid,$a->id])}}" class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Change Status</a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <form action="{{route('personal_guarantor.destroy',[$bid,$a->id])}}" method="post">
                                                    {{csrf_field()}}
