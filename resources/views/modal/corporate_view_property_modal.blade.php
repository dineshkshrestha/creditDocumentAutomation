                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                ...
                                                <a href="{{route('corporate_property.land_borrower_edit',[$bid,$a->id,'personal',$status])}}"
                                                   class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                            </li>
                                            <li>
                                                <a href="">
                                                    <form action="{{route('corporate_property.land_borrower_destroy',[$bid,$a->id,'personal',$status])}}"
                                                          method="post">
                                                        {{csrf_field()}}
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                ...
                                                <a href="{{route('corporate_property.land_borrower_edit',[$bid,$a->id,'corporate',$status])}}"
                                                   class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                            </li>
                                            <li>
                                                <a href="">
                                                    <form action="{{route('corporate_property.land_borrower_destroy',[$bid,$a->id,'corporate',$status])}}"
                                                          method="post">
                                                        {{csrf_field()}}
                                                        <input type="hidden" name="_method" value="delete">
                                                        <button type="submit" class="btn btn-default btn-xs"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="{{route('corporate_property.share_borrower_edit',[$bid,$a->id,'personal',$status])}}"
                                                   class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                            </li>
                                            <li>
                                                <a href="">
                                                    <form action="{{route('corporate_property.share_borrower_destroy',[$bid,$a->id,'personal',$status])}}"
                                                          method="post">
                                                        {{csrf_field()}}
                                                        <input type="hidden" name="_method" value="delete">
                                                        <button type="submit" class="btn btn-default btn-xs"
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                ...
                                                <a href="{{route('corporate_property.share_borrower_edit',[$bid,$a->id,'corporate',$status])}}"
                                                   class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                            </li>
                                            <li>
                                                <a href="">
                                                    <form action="{{route('corporate_property.share_borrower_destroy',[$bid,$a->id,'corporate',$status])}}"
                                                          method="post">
                                                        {{csrf_field()}}
                                                        <input type="hidden" name="_method" value="delete">
                                                        <button type="submit" class="btn btn-default btn-xs"
