...
@section('breadcrumb')
    ...
    <li class="active"><strong>View All Department</strong></li>
...
@section('content')
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><a class="btn btn-success btn-xs" href={{route('department.create')}}>Create
                    Department</a></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('department.edit',$a->id)}}" class="btn-xs"> <i class="lnr lnr-pencil"></i>Edit</a>
                                    </li>
                                    <li>

                                        <a href="">
                                            <form action="{{route('department.destroy',$a->id)}}" method="post">
                                                {{csrf_field()}}
