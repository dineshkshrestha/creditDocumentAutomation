...
@section('small_heading','Please edit the Vehicle details.')
@section('borrower')
...
@section('breadcrumb')
    ...
    {{--<li><a href="{{route('personal_property.choose',[$bid,$land->property_owner_id,$status])}}">Property List </a></li>--}}
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['personal_property.vehicle_update',$vehicle->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                ...
                <table>
                    ...
                    <tr>
                        <td style=" font-size:14px; ">{!! form::text('engine_number',$vehicle->engine_number,['class'=>'form-control input-sm','id'=>'engine_number','autocomplete'=>'off','required'=>'required']) !!}
                            @if($errors->has('engine_number'))
                                <span class="label label-danger">{{$errors->first('engine_number')}} </span>
                            @endif
                        </td>
                        <td style=" font-size:14px; ">{!! form::text('chassis_number',$vehicle->chassis_number,['class'=>'form-control input-sm','id'=>'chassis_number','autocomplete'=>'off','required'=>'required']) !!}
