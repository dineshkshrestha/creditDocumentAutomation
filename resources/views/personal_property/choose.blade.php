...
@section('breadcrumb')
    ...
    <li><a href="{{route('personal_property.index',$bid)}}">Select Property Owner</a></li>
...
@section('content')
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            ...
            <span><a class="btn btn-info btn-xm pull-right" href="{{route('personal_property.proceed',$bid)}}">                 <i
        ...
        <div class="box-body">
            @if($land_property)
                <table
                    ...
                    <thead>
                    <tr>
                        <th colspan="8">Available Land Properties</th>
                    </tr>
                    <tr>
                        <th>SN</th>
                        <th>District</th>
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            ...
                                            <a href="{{route('personal_property.land_assign',[$bid,$a->id,$status])}}"
                                               class="btn-xs"> <i class="fa  fa-check-square fa-fw"></i>Assign Property</a>
                                        </li>

                                        <li>

                                            <a href="{{route('personal_property.land_edit',[$bid,$a->id,$status])}}"
                                               class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <form action="{{route('personal_property.land_destroy',[$bid,$a->id,$status])}}"
                                                      method="post">
                                                    {{csrf_field()}}
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            ...
                                            <a href="{{route('personal_property.share_assign',[$bid,$a->id,$status])}}"
                                               class="btn-xs"> <i class="fa  fa-check-square fa-fw"></i>Assign Property</a>
                                        </li>

                                        <li>

                                            <a href="{{route('personal_property.share_edit',[$bid,$a->id,$status])}}"
                                               class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <form action="{{route('personal_property.share_destroy',[$bid,$a->id,$status])}}"
                                                      method="post">
                                                    {{csrf_field()}}
                                                    <input type="hidden" name="_method" value="delete">
                                                    <button type="submit" class="btn btn-default btn-xs"
    ...
    {!! Form::open(['route' => 'personal_property.land_store','method'=>'post'],['class'=>'form-horizontal']) !!}
    ...
    {!! form::hidden('status',$status,['class'=>'form-control','hidden','id'=>'status','hidden']) !!}
    @include('modal.land_create_modal')

    {!! Form::open(['route' => 'personal_property.share_store','method'=>'post'],['class'=>'form-horizontal']) !!}
    {!! form::hidden('bid',$bid,['class'=>'form-control','hidden'=>'hidden','id'=>'bid','hidden']) !!}
    {!! form::hidden('poid',$poid,['class'=>'form-control','hidden','id'=>'poid','hidden']) !!}
    {!! form::hidden('status',$status,['class'=>'form-control','hidden','id'=>'status','hidden']) !!}
    @include('modal.share_create_modal')

    @include('modal.personal_view_property_modal')
