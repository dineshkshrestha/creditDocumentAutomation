    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><a class="btn btn-success btn-xs" data-toggle="modal"
                ...
                <span><a class="btn btn-success btn-xs"  href="{{route('personal_property.proceed',$bid)}}">Choose From Borrowers and Guarantors </a></span>
            </h3><span><a class="btn btn-info btn-xm pull-right"  href="{{route('personal_property.proceed',$bid)}}">Proceed to Banking Facilities </a></span>
                ...
                @foreach($personal_borrower as $a)
                    @if($a->status==1)
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-primary btn-xs" href="{{route('personal_property.personal_borrower',[$bid,$a->id])}}">
                ...
                @foreach($personal_guarantor as $a)
                    @if($a->status==1)
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-primary btn-xs" href="{{route('personal_property.personal_select',[$bid,$a->id])}}">
                                    <i class="fa  fa-square-o fa-fw"></i>Select as Property Owner</a>
                            </td>
                ...
                @foreach($corporate_borrower as $a)
                    @if($a->status==1)
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-primary btn-xs" href="{{route('personal_property.corporate_borrower',[$bid,$a->id])}}">
                                    <i class="fa  fa-square-o fa-fw"></i>Select as Property Owner</a>
                            </td>
                ...
                @foreach($corporate_guarantor as $a)
                    @if($a->status==1)
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-primary btn-xs" href="{{route('personal_property.corporate_select',[$bid,$a->id])}}">
                                    <i class="fa  fa-square-o fa-fw"></i>Select as Property Owner</a>
                            </td>
