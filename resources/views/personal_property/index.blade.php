...
@endsection
@section('content')
    {!! Form::open(['route' => 'personal_property.vehicle_store','method'=>'post'],['class'=>'form-horizontal']) !!}
    {!! form::hidden('bid',$bid,['class'=>'form-control','hidden'=>'hidden','id'=>'bid','hidden']) !!}
    @include('modal.vehicle_create_modal')
    @include('modal.property_from_personal_guarantor_modal')
    @include('modal.vehicle_view_modal')
            ...
            <h3 class="box-title">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="{{route('personal_property_join.index',$bid)}}">
                                <i class="fa fa-group fa-fw"></i>Joint Property Owner</a>
                        </li>

                        <li>
                            <a href="{{route('personal_property.personal_create',$bid)}}">
                                <i class="fa fa-male fa-fw"></i>New Personal Property Owner</a>
                        </li>
                        <li>

                            <a href="{{route('personal_property.corporate_create',$bid)}}">
                        ...
                        <li>
                            ...
                            <a href="{{route('personal_property.copy_property_owner',$bid)}}">
                        ...
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-primary btn-xs"
                                   href="{{route('personal_property.personal_property_owner',[$bid,$a->id])}}">
                ...
                @foreach($corporate_property_owner as $a)
                    @if($a->status==1)
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-primary btn-xs"
                                   href="{{route('personal_property.corporate_property_owner',[$bid,$a->id])}}">
                                    <i class="fa  fa-square-o fa-fw"></i>Select as Property Owner</a>
                            </td>
    ...
    <!-- /.box-body --
    >
  @include('modal.personal_view_property_modalfront')
