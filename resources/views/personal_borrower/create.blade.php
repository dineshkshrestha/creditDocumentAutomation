...
@section('title',' Personal Borrower Create ')
@section('heading','Personal Borrower')
@section('small_heading','Create')
@section('breadcrumb')
    <li><a href="{{route('home')}}">Dashboard</a></li>
    <li><a href="{{route('personal_borrower.index')}}">View All Personal Borrowers</a></li>
    <li class="active"><strong>Create Personal Borrower</strong></li>
@endsection
@section('css')
@endsection
@section('content')
    ...
    <div class="col-md-10">
        <div class="box box-default ">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <a class="btn btn-success btn-xs" href={{route('personal_borrower.index')}}>Available
                        Personal Borrowers</a>
                </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' => 'personal_borrower.store','method'=>'post'],['class'=>'form-horizontal']) !!}
