...
@section('content')
            ...
            <h3 class="box-title">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{{route('personal_guarantor_borrower.index')}}">
                                <i class="fa fa-clone"></i>Copy Details
                                From
                                Guarantor</a>
                        </li>
                        <li>
                            <a href="{{route('personal_property_owner_borrower.index')}}">
                                <i class="fa fa-clone"></i>Copy Details
                    ...
                    <tr>@php($bid=$a->id)
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('personal_borrower.select',$bid)}}">
                                    ...
                                    <li>
                                        <a href="{{route('personal_borrower.edit',$a->id)}}" class="btn-xs"> <i
                                                    class="fa fa-pencil fa-fw"></i>Edit</a>
                                    </li>
                                    <li>

                                        <a href="">
                                            <form action="{{route('personal_borrower.destroy',$a->id)}}" method="post">
                                                {{csrf_field()}}
    ...
    <!-- /.box-body -->
    {!! Form::open(['route' => 'personal_borrower.store','method'=>'post','novalidate' => 'novalidate'],['class'=>'form-horizontal']) !!}
