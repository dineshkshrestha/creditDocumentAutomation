...
@section('small_heading','Profile')
@section('breadcrumb')
    <li><a href="{{route('home')}}">Dashboard</a></li>
    <li class="active"><strong>View User</strong></li>
                ...
                <div class="col-md-4">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <a href="{{route('userregister.edit',$user->id)}}" class="btn btn-primary btn-block"><b>Edit User</b></a>
                            <a href="{{route('user.change_password',$user->id)}}" class="btn btn-info btn-block"><b>Change Password</b></a>
                        </div>
                        <!-- /.box-body -->
                    </div>
                    <!-- /.box -->
