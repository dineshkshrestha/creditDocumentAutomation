                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('joint_property_owner_borrower.select',$bid)}}">
                                    ...
                                    <li>
                                        <a href="{{route('joint_property_owner_borrower.edit',$a->id)}}"
                                           class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                    </li>
                                    <li>

                                        <a href="">
                                            <form action="{{route('joint_property_owner_borrower.destroy',$a->id)}}"
                                                  method="post">
                                                {{csrf_field()}}
