...
@section('breadcrumb')
    ...
    <li><a href="{{route('joint_property_owner_borrower.index')}}">View All Personal Property Owner</a></li>
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['joint_property_owner_borrower.update',$property_owner->id],'method'=>'post','class'=>'form-horizontal','enctype'=>'multipart/form-data','novalidate'=>'novalidate']) !!}
