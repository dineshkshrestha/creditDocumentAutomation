...
@section('breadcrumb')
    ...
    <li><a href="{{route('joint_borrower.index')}}">Select Personal Borrower</a></li>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('joint_guarantor_borrower.select',$bid)}}">
                                    ...
                                    <li>
                                        <a href="{{route('joint_guarantor_borrower.edit',$a->id)}}" class="btn-xs"> <i
                                                    class="fa fa-pencil fa-fw"></i>Edit</a>
                                    </li>
                                    <li>

                                        <a href="">
                                            <form action="{{route('joint_guarantor_borrower.destroy',$a->id)}}" method="post">
                                                {{csrf_field()}}
