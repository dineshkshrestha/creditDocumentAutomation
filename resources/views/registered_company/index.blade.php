...
@section('title',' Registered Company List ')
@section('heading','Registered Company')
@section('small_heading','List')
@section('breadcrumb')
    <li><a href="{{route('home')}}">Dashboard</a></li>
    <li class="active"><strong>View All Registered Company</strong></li>
...
@section('content')
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title"><a class="btn btn-success btn-xs" href={{route('registered_company.create')}}>Create
                    Registered Company</a></h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
            ...
            <table id="permission" class="table table-striped table-bordered table-hover dataTables-example">
                ...
                <tbody>
                @php($i=1)
                @foreach($registered_company as $a)
                    <tr>
                        <td>{{$i++}}</td>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('registered_company.edit',$a->id)}}" class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                    </li>
                                    <li>

                                        <a href="">
                                            <form action="{{route('registered_company.destroy',$a->id)}}" method="post">
                                                {{csrf_field()}}
