...
@section('breadcrumb')
    ...
    <li><a href="{{route('corporate_property.index',$bid)}}">Property</a></li>
...
@section('content')
    <div class="box box-default">
        ...
        <!-- /.box-header -->
        {!! Form::open(['route' => ['corporate_property.corporate_store',$bid],'method'=>'post','novalidate' => 'novalidate'],['class'=>'form-horizontal']) !!}
