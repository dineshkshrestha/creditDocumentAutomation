...
@section('small_heading','Please edit the land details.')
@section('borrower')
...
@section('breadcrumb')
    ...
    <li><a href="{{route('corporate_property.choose',[$bid,$land->property_owner_id,$status])}}">Corporate List </a></li>
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['corporate_property.land_update',$land->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                ...
                <table>
                    ...
                    <tr>
                        <td style="padding-right: 12px; ">{!! form::text('sheet_no',$land->sheet_no,['class'=>'form-control input-sm','id'=>'sheet_no','style'=>'font-size:14px; font-family:Bishallb,FONTASY_ HIMALI_ TT;','autocomplete'=>'off']) !!}
                    ...
                    <tr>
                        <td style=" padding-right: 12px; ">{!! form::text('area',$land->area,['class'=>'form-control input-sm','style'=>'font-size:14px; font-family:Bishallb,FONTASY_ HIMALI_ TT;','id'=>'area','autocomplete'=>'off','required'=>'required']) !!}
                            ...
                            @endif</td>
                        <td style=" padding-right: 12px;">{!! form::text('remarks',$land->remarks,['class'=>'form-control input-sm','style'=>'font-size:14px; font-family:Bishallb,FONTASY_ HIMALI_ TT;','id'=>'remarks','autocomplete'=>'off']) !!}
