...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['corporate_property.share_borrower_update',$share->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                ...
                <table>
                    ...
                    <tr>
                        <td style="padding-right: 12px; ">{!! form::text('client_id',$share->client_id,['style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px; ','class'=>'form-control input-sm','id'=>'instclientid','autocomplete'=>'off']) !!}
