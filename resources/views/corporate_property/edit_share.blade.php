...
@section('breadcrumb')
    ...
    <li><a href="{{route('corporate_property.choose',[$bid,$share->property_owner_id,$status])}}">Corporate List </a></li>
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['corporate_property.share_update',$share->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                ...
                <table>
                    ...
                    <tr>
                        <td style="padding-right: 12px; ">{!! form::text('client_id',$share->client_id,['style'=>'font-size:14px; ','class'=>'form-control input-sm','id'=>'instclientid','autocomplete'=>'off']) !!}
