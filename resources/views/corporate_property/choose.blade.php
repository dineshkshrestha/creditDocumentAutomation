...
@section('breadcrumb')
    ...
    <li><a href="{{route('corporate_property.index',$bid)}}">Select Property Owner</a></li>
...
@section('content')
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            ...
                                            <a href="{{route('corporate_property.land_assign',[$bid,$a->id,$status])}}"
                                               class="btn-xs"> <i class="fa  fa-check-square fa-fw"></i>Assign Property</a>
                                        </li>

                                        <li>

                                            <a href="{{route('corporate_property.land_edit',[$bid,$a->id,$status])}}"
                                               class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <form action="{{route('corporate_property.land_destroy',[$bid,$a->id,$status])}}"
                                                      method="post">
                                                    {{csrf_field()}}
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            ...
                                            <a href="{{route('corporate_property.share_assign',[$bid,$a->id,$status])}}"
                                               class="btn-xs"> <i class="fa  fa-check-square fa-fw"></i>Assign Property</a>
                                        </li>

                                        <li>

                                            <a href="{{route('corporate_property.share_edit',[$bid,$a->id,$status])}}"
                                               class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <form action="{{route('corporate_property.share_destroy',[$bid,$a->id,$status])}}"
                                                      method="post">
                                                    {{csrf_field()}}
                                                    <input type="hidden" name="_method" value="delete">
                                                    <button type="submit" class="btn btn-default btn-xs"
    ...
    {!! Form::open(['route' => 'corporate_property.land_store','method'=>'post'],['class'=>'form-horizontal']) !!}
    ...
    {!! Form::open(['route' => 'corporate_property.share_store','method'=>'post'],['class'=>'form-horizontal']) !!}
    {!! form::hidden('bid',$bid,['class'=>'form-control','hidden'=>'hidden','id'=>'bid','hidden']) !!}
    {!! form::hidden('poid',$poid,['class'=>'form-control','hidden','id'=>'poid','hidden']) !!}
    {!! form::hidden('status',$status,['class'=>'form-control','hidden','id'=>'status','hidden']) !!}
    @include('modal.share_create_modal')

    @include('modal.corporate_view_property_modal')
