...
@section('breadcrumb')
    ...
    <li><a href="{{route('joint_facilities.index',$bid)}}">Facility List </a></li>
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['joint_facilities.update',$facility->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
