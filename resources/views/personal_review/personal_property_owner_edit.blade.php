    ...
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <div class="box-body">
                ...
                {!! Form::open(['route' =>['personal_review.personal_property_owner_update',$id ],'method'=>'post','novalidate' => 'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="padding-right: 12px">  {!! form::select('dob_year',['1980'=>'1980','1981'=>'1981',
                                        ...
                                        '2074'=>'2074','2075'=>'2075','2076'=>'2076'],$property_owner->dob_year,['class'=>'form-control input-sm','id'=>'dyear','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}</td>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="padding-right: 12px">  {!! form::select('issued_year',['1980'=>'1980','1981'=>'1981',
                                        ...
                                        '2066'=>'2066','2067'=>'2067','2068'=>'2068','2069'=>'2069',
                                        '2070'=>'2070','2071'=>'2071','2072'=>'2072','2073'=>'2073',
                                        '2074'=>'2074','2075'=>'2075','2076'=>'2076'],$property_owner->issued_year,['class'=>'form-control input-sm','id'=>'dyear','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="padding-right: 12px">
                            {!! form::select('father_relation',['%f]/f '=>'%f]/f ','%f]/L '=>'%f]/L '],$property_owner->father_relation,['class'=>'form-control input-sm','id'=>'father-relation','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
