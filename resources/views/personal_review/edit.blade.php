...
@section('breadcrumb')
    ...
    <li><a href="{{route('personal_guarantor.index',$id)}}">Guarantor</a></li>
    <li><a href="{{route('personal_property.index',$id)}}">Property</a></li>
    <li><a href="{{route('personal_facilities.index',$id)}}">Loan Details</a></li>
    <li><a href="{{route('personal_review.index',$id)}}">Review</a></li>
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['personal_review.update',$borrower->id],'method'=>'post','class'=>'form-horizontal','novalidate'=>'novalidate','enctype'=>'multipart/form-data']) !!}
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="padding-right: 12px">
                            {!! form::select('father_relation',['%f]/f'=>'%f]/f ','%f]/L'=>'%f]/L '],$borrower->father_relation,['class'=>'form-control input-sm','id'=>'father-relation','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
