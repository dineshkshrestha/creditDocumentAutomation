...
@section('content')
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            ...
            <span><a class="btn btn-info btn-xm pull-right" href="{{route('joint_property_personal.index',$bid)}}">
                        ...
                        <td>
                            <div class="btn-group">
                                <a class="btn btn-primary  btn-xs dropdown-toggle" data-toggle="dropdown" href="#">
                                    ...
                                    Choose Joint Owner <span class="fa fa-caret-down"
                                                             title="Toggle dropdown menu"></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('joint_property_personal.select',[$bid,$a->id])}}">
    ...
    {!! Form::open(['route' => 'joint_property_personal.newstore','method'=>'post','novalidate' => 'novalidate'],['class'=>'form-horizontal']) !!}
