...
@section('breadcrumb')
    ...
    <li><a href="{{route('joint_property_personal.index',$bid)}}">Joint Owner</a></li>
    <li class="active"><strong>Property Edit</strong></li>
@endsection
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['joint_property_personal.land_update',$land->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
