...
@section('heading','Add/Select Property')
...
@section('breadcrumb')
    ...
    <li><a href="{{route('joint_property_personal.owner_create',$bid)}}">Joint Owner</a></li>
    <li class="active"><strong>Property</strong></li>
@endsection
...
@section('content')
            ...
            <h3 class="box-title">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{{route('joint_property_personal.owner_create',$bid)}}">
                                <i class="fa fa-plus fa-fw"></i>
                                Add New Owner
                            </a>
                        </li>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('joint_property_personal.land_edit',[$bid,$a->id])}}"
                                           class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                    </li>
                                    <li>
                                        <a href="">
                                            <form action="{{route('joint_property_personal.land_destroy',[$bid,$a->id])}}"
                                                  method="post">
                                                {{csrf_field()}}
    ...
    {!! Form::open(['route' => 'joint_property_personal.land_store','method'=>'post'],['class'=>'form-horizontal']) !!}
    ...
    @include('modal.joint_joint_view_modal')
