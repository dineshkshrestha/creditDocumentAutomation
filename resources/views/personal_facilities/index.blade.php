...
@section('content')
    <div class="box box-default">
        ...
        <div class="box-header with-border">
            <h3 class="box-title">
                ...
                {!! Form::open(['route' => 'personal_loan.store','method'=>'post'],['class'=>'form-horizontal']) !!}
                {!! form::hidden('bid',$bid,[]) !!}
            </h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('personal_facilities.edit',[$bid, $f->id])}}">
                                            <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                    </li>
                                    <li>
                                        <a href="">
                                            <form action="{{route('personal_facilities.destroy',$f->id)}}"
                                                  method="post">
                                                {{csrf_field()}}
    ...
    {!! Form::open(['route' =>'personal_facilities.store','method'=>'post'],['class'=>'form-horizontal']) !!}
