...
@section('title',' Edit Facility Property')
@section('heading','Edit Facility')
@section('small_heading','Please edit the Facility details.')
@section('borrower')
...
@section('breadcrumb')
    ...
    <li><a href="{{route('personal_facilities.index',$bid)}}">Property List </a></li>
    <li class="active"><strong>Facility Edit</strong></li>
@endsection
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['personal_facilities.update',$facility->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
