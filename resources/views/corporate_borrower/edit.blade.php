...
@section('breadcrumb')
    ...
    <li><a href="{{route('corporate_borrower.index')}}">View All Corporate Borrowers</a></li>
    <li class="active"><strong>Edit Corporate Borrower</strong></li>
@endsection
@section('content')

        <div class="box box-default">
            {!! Form::open(['route' =>['corporate_borrower.update',$borrower->id],'method'=>'post','novalidate' => 'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
            <div class="box-body">
                ...
                <table>
                    ...
                    <tr>
                        <td style="padding-right: 12px">
                            {!! form::select('a_post',['k|f]kfO^/'=>'k|f]kfO^/',';fem]bf/'=>';fem]bf/',';+rfns'=>';+rfns','sd{rf/L'=>'sd{rf/L','cWoIf'=>'cWoIf','=========================='=>'=========================='],$authorized_person->post,['class'=>'form-control input-sm','id'=>'post','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT;width:200px; font-size:14px;','autocomplete'=>'off']) !!}
                        </td>
                ...
                '2066'=>'2066','2067'=>'2067','2068'=>'2068','2069'=>'2069',
                '2070'=>'2070','2071'=>'2071','2072'=>'2072','2073'=>'2073',
                '2074'=>'2074','2075'=>'2075','2076'=>'2076'],$authorized_person->issued_year,['class'=>'form-control input-sm','id'=>'dyear','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
