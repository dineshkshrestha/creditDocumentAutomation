                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('corporate_guarantor_borrower.select',$a->id)}}">
                                            <i class="fa fa-navicon fa-fw"></i>Select as Borrower</a>
                                    </li>
                                    <li>
                                        <a href="{{route('corporate_guarantor_borrower.show',$a->id)}}">
                                            <i class="fa fa-eye fa-fw"></i>View All Details</a>
                                    </li>
                                    <li>
                                        <a href="{{route('corporate_guarantor_borrower.edit',$a->id)}}" class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                    </li>
                                    <li>

                                        <a href="">
                                            <form action="{{route('corporate_guarantor_borrower.destroy',$a->id)}}" method="post">
                                                {{csrf_field()}}
