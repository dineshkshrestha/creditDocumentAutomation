...
@section('small_heading','Create Personal guarantors')
@section('borrower')
...
@section('breadcrumb')
    ...
    <li class="active"><strong>New Personal Guarantor</strong></li>
@endsection
@section('css')
    <link rel="stylesheet"
...
@section('content')
    ...
    <div class="box box-default">
        ...
        <!-- /.box-header -->
        {!! Form::open(['route' => ['corporate_guarantor.personal_store',$bid],'method'=>'post','novalidate' => 'novalidate'],['class'=>'form-horizontal']) !!}
        ...
        <div class="box-body">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="padding-right: 12px">  {!! form::select('gender',['1'=>'Male','0'=>'Female'],'1',['class'=>'form-control input-sm','id'=>'gender','style'=>"width:100px",'required'=>'required']) !!}</td>
                </tr>
            </table>
            <table>
                <tr>
                    <td style="padding-right: 12px">  {!! form::label('client_id','Client ID') !!}</td>
                    <td style="padding-right: 12px" width="100"><b> {!! form::label('date','Date of Birth') !!}</b></td>
                ...
                <tr>
                    <td  style="padding-right: 12px; width:200px; ">  {!! form::text('client_id','',['class'=>'form-control input-sm','id'=>'clientid','autocomplete'=>'off']) !!}</td>
                    @if($errors->has('client_id'))
                        <span class="label label-danger">{{$errors->first('client_id')}} </span>
                    @endif
                    <td style="padding-right: 12px">  {!! form::label('bs','B.S.') !!}</td>
                    <td style="padding-right: 12px">  {!! form::select('dob_year',['1990'=>'1990','1991'=>'1991',
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="padding-right: 12px" width="150">  {!! form::label('local_bodies_id','Local Government') !!}</td>
                ...
                <tr>
                    <td style="padding-right: 12px">  {!! form::select('district_id',$district,'',['class'=>'form-control input-sm','id'=>'district_id','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
                        ...
                        @endif</td>
                    <td style="padding-right: 12px">  {!! form::select('local_bodies_id',$localbody,'',['class'=>'form-control input-sm','id'=>'localbody_id','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
            ...
            <table>
                ...
                <tr>
                    <td style="padding-right: 12px" width="150">  {!! form::label('citizenship_number',' Citizenship Number') !!}</td>
                    <td style="padding-right: 12px" width="100">  {!! form::label('issued_district','Issued District') !!}</td>

                </tr>
                <tr>
                    <td style="padding-right: 12px"> {!! form::text('citizenship_number','',['class'=>'form-control input-sm','id'=>'citizenshipno','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','required'=>'required','autocomplete'=>'off']) !!}
                        @if($errors->has('citizenship_number'))
                            <span class="label label-danger">{{$errors->first('citizenship_number')}} </span>
                        @endif</td>
                    <td style="padding-right: 12px">  {!! form::select('issued_district',$district,'',['class'=>'form-control input-sm','id'=>'name','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
            ...
            <table>
                ...
                <tr>
                    <td style="padding-right: 12px">  {!! form::label('bs','B.S.') !!}</td>
                    <td style="padding-right: 12px">  {!! form::select('issued_year',['1990'=>'1990','1991'=>'1991',
                                        '1992'=>'1992','1993'=>'1993','1994'=>'1994','1995'=>'1995',
                                        '1996'=>'1996','1997'=>'1997','1998'=>'1998','1999'=>'1999','2000'=>'2000','2001'=>'2001',
                                        '2002'=>'2002','2003'=>'2003','2004'=>'2004','2005'=>'2005',
                                        '2006'=>'2006','2007'=>'2007','2008'=>'2008','2009'=>'2009',
            ...
            <table>
                ...
                <tr>
                    <td style="padding-right: 12px" width="250">  {!! form::label('grandfather_name','(Grand Father/Father InLaw) Name') !!}</td>
                    <td style="padding-right: 12px">  {!! form::label('grandfather_relation','Relation with Borrower') !!}</td>
                </tr>
                <tr>
                    <td style="padding-right: 12px"> {!! form::text('grandfather_name','',['class'=>'form-control input-sm','id'=>'gfname','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
                        @if($errors->has('grandfather_name'))
                            <span class="label label-danger">{{$errors->first('grandfather_name')}} </span>
                        @endif</td>
                    <td style="padding-right: 12px">  {!! form::select('grandfather_relation',['gflt'=>'gflt','gfltgL'=>'gfltgL','a"xf/L'=>'a"xf/L'],'gflt',['class'=>'form-control input-sm form-inline','id'=>'name','required'=>'required','autocomplete'=>'off','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;']) !!}
                ...
                <tr>
                    <td style="padding-right: 12px" width="250">  {!! form::label('father_name','Father Name') !!}</td>
                    <td style="padding-right: 12px">  {!! form::label('father_relation-relation','Relation with Borrower') !!}</td>
                </tr>
                <tr>
                    <td style="padding-right: 12px">  {!! form::text('father_name','',['class'=>'form-control input-sm','id'=>'father_name','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
                        @if($errors->has('father_name'))
                            <span class="label label-danger">{{$errors->first('father_name')}} </span>
                        @endif
                    </td>
                    <td style="padding-right: 12px">
                        {!! form::select('father_relation',['%f]/f '=>'%f]/f ','%f]/L '=>'%f]/L ',' klTg'=>'klTg'],'%f]/f ',['class'=>'form-control input-sm','id'=>'father-relation','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
                ...
                <tr>
                    <td style="padding-right: 12px">  {!! form::text('spouse_name','',['class'=>'form-control input-sm','id'=>'spouse_name','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
                        @if($errors->has('spouse_name'))
                            <span class="label label-danger">{{$errors->first('spouse_name')}} </span>
                        @endif
                    </td>
                    <td style="padding-right: 12px">
                        {!! form::select('spouse_relation',['klt '=>'klt ',' klTg'=>'klTg'],'klTg',['class'=>'form-control input-sm','id'=>'spouse_relation','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
