    ...
    <div class="col-sm-8">
        <div class="box box-default">
            <div class="box-header with-border">
                <h3 class="box-title">
                    <span class="label label-danger btn-xs pull-left " href="#">
                        <i class="fa fa-info-circle fa-fw"></i>
                        To convert the amount to words, please remove comma(,)*
                    </span>

                </h3>
                <span ><a class="btn btn-info btn-xm pull-right" href="{{route('corporate_loan.proceed',$bid)}}">                 <i
            ...
            <div class="box-body">
                ...
                @if($loan)
                    ...
                    <table>
                        ...
                        <tr>
                            <td width="200" style="padding-right: 12px">  {!! form::select('loan_type',$facility,$loan->loan_type_id,['class'=>'form-control input-sm','id'=>'facility','autocomplete'=>'off','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;']) !!}
                ...
                @else
                    <table>
                        ...
                        <tr>
                            <td width="200" style="padding-right: 12px">  {!! form::select('loan_type',$facility,'',['class'=>'form-control input-sm','id'=>'facility','autocomplete'=>'off','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;']) !!}
                            @if($errors->has('loan_type'))
                                <span class="label label-danger">{{$errors->first('loan_type')}} </span>
                            @endif
</td>
