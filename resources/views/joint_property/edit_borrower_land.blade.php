...
@section('heading','Edit Land Details')
...
@section('breadcrumb')
    ...
    <li><a href="{{route('joint_property.choose',[$bid,$land->property_owner_id])}}">Property List </a></li>
...
@section('content')
    ...
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['joint_property.land_borrower_update',$land->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
