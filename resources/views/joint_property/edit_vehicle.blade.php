...
@section('breadcrumb')
    ...
    {{--<li><a href="{{route('joint_property.choose',[$bid,$land->property_owner_id,$status])}}">Property List </a></li>--}}
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['joint_property.vehicle_update',$vehicle->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
