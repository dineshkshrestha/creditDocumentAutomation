...
@section('breadcrumb')
    ...
    <li class="active"><strong>New joint Property Owner</strong></li>
@endsection
@section('css')
    <link rel="stylesheet"
...
@section('content')
    ...
    <div class="box box-default">
        ...
        <!-- /.box-header -->
        {!! Form::open(['route' => ['joint_property.personal_store',$bid],'method'=>'post','novalidate' => 'novalidate'],['class'=>'form-horizontal']) !!}
