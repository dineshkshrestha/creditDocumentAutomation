...
@section('breadcrumb')
    ...
    <li><a href="{{route('joint_borrower.index')}}">Personal Borrower</a></li>
    <li><a href="{{route('joint_guarantor.index',$bid)}}">Personal Guarantor</a></li>
    <li><a href="{{route('joint_property.index',$bid)}}">Property Owner</a></li>
    <li><a href="{{route('joint_property.choose',[$bid,$share->property_owner_id])}}">Property List </a></li>
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['joint_property.share_update',$share->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
