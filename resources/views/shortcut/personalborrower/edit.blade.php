...
@section('breadcrumb')
    ...
    <li><a href="{{route('PersonalBorrower.index')}}">View All Personal Borrowers</a></li>
    <li class="active"><strong>Edit Personal Borrower</strong></li>
@endsection
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['PersonalBorrower.update',$borrower->id],'novalidate'=>'novalidate','method'=>'post','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="padding-right: 12px">  {!! form::select('dob_year',['1980'=>'1980','1981'=>'1981',
                                        ...
                                        '2074'=>'2074','2075'=>'2075','2076'=>'2076'],$borrower->dob_year,['class'=>'form-control input-sm','id'=>'dyear','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}</td>
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td style="padding-right: 12px">  {!! form::select('issued_year',['1980'=>'1980','1981'=>'1981',
                                        ...
                                        '2066'=>'2066','2067'=>'2067','2068'=>'2068','2069'=>'2069',
                                        '2070'=>'2070','2071'=>'2071','2072'=>'2072','2073'=>'2073',
                                        '2074'=>'2074','2075'=>'2075','2076'=>'2076'],$borrower->issued_year,['class'=>'form-control input-sm','id'=>'dyear','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
                ...
                <table>
                    ...
                    <tr>
                        <td style="padding-right: 12px">  {!! form::text('spouse_name',$borrower->spouse_name,['class'=>'form-control input-sm','id'=>'spouse_name','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
                            @if($errors->has('spouse_name'))
                                <span class="label label-danger">{{$errors->first('spouse_name')}} </span>
                            @endif
                        </td>
                        <td style="padding-right: 12px">
                            {!! form::select('spouse_relation',['klt '=>'klt ',' klTg'=>'klTg'],$borrower->spouse_relation,['class'=>'form-control input-sm','id'=>'spouse_relation','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
