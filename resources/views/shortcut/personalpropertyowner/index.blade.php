...
@section('title',' Personal Property Owner List ')
@section('heading','Select Personal')
@section('small_heading','Property Owner')
@section('breadcrumb')
    <li><a href="{{route('home')}}">Dashboard</a></li>
    <li class="active"><strong>Select Personal Property Owner</strong></li>
@endsection
@section('css')
    <link rel="stylesheet"
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('PersonalPropertyOwner.show',$a->id)}}">
                                            <i class="fa fa-eye fa-fw"></i>View All Details</a>
                                    </li>
                                    <li>
                                        <a href="{{route('PersonalPropertyOwner.edit',$a->id)}}" class="btn-xs"> <i
                                                    class="fa fa-pencil fa-fw"></i>Edit</a>
                                    </li>
                                    <li>

                                        <a href="">
                                            <form action="{{route('PersonalPropertyOwner.destroy',$a->id)}}" method="post">
                                                {{csrf_field()}}
