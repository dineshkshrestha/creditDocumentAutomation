...
@section('heading','Corporate Borower')
@section('small_heading','Borrower')
@section('breadcrumb')
    <li><a href="{{route('home')}}">Dashboard</a></li>
    <li class="active"><strong>Corporate Borrower</strong></li>
@endsection
@section('css')
    <link rel="stylesheet"
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="{{route('CorporateBorrower.edit',$a->id)}}" class="btn-xs"> <i
                                                        class="fa fa-pencil fa-fw"></i>Edit</a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <form action="{{route('CorporateBorrower.destroy',$a->id)}}"
                                                      method="post">
                                                    {{csrf_field()}}
