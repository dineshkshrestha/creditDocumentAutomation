...
@section('content')
    ...
    <div class="box box-default">
        {!! Form::open(['route' =>['CorporateBorrower.update',$borrower->id],'method'=>'post','novalidate' => 'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
        <div class="box-body">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="padding-right: 12px">
                        {!! form::select('a_father_relation',['%f]/f '=>'%f]/f ','%f]/L '=>'%f]/L '],$authorized_person->a_father_relation,['class'=>'form-control input-sm','id'=>'father-relation','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}
