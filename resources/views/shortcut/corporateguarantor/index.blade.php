...
@section('title',' Corporate Guarantor List ')
@section('heading','Corporate Guarantor')
@section('small_heading','Guarantor')
@section('breadcrumb')
    <li><a href="{{route('home')}}">Dashboard</a></li>
    <li class="active"><strong>Corporate Guarantor</strong></li>
@endsection
@section('css')
    <link rel="stylesheet"
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a href="{{route('CorporateGuarantor.edit',$a->id)}}" class="btn-xs"> <i
                                                        class="fa fa-pencil fa-fw"></i>Edit</a>
                                        </li>
                                        <li>
                                            <a href="">
                                                <form action="{{route('CorporateGuarantor.destroy',$a->id)}}"
                                                      method="post">
                                                    {{csrf_field()}}
