...
@section('title',' Corporate Property Owner Edit ')
@section('heading','Corporate Property Owner')
@section('small_heading','Edit')
@section('breadcrumb')
    <li><a href="{{route('home')}}">Dashboard</a></li>
    <li><a href="{{route('CorporatePropertyOwner.index')}}">View All Corporate Property Owners</a></li>
    <li class="active"><strong>Edit Corporate Property Owner</strong></li>
@endsection
@section('content')

    <div class="box box-default">
        {!! Form::open(['route' =>['CorporatePropertyOwner.update',$property_owner->id],'method'=>'post','novalidate' => 'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
        <div class="box-body">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="padding-right: 12px">  {!! form::select('reg_year',['1980'=>'1980','1981'=>'1981',
                                        ...
                                        '2074'=>'2074','2075'=>'2075','2076'=>'2076'],$property_owner->reg_year,['class'=>'form-control input-sm','id'=>'dyear','required'=>'required','style'=>'font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;','autocomplete'=>'off']) !!}</td>
            ...
            <table>
                <tr>
                    ...
                    <td style="padding-right: 12px">  {!! form::label('a_grandfather_relation','Relation with Property Owner') !!}</td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="padding-right: 12px">  {!! form::label('a_father_relation','Relation with Property Owner') !!}</td>
                ...
                <tr>
                    ...
                    <td style="padding-right: 12px">  {!! form::label('a_spouse_relation','Relation with Property Owner') !!}</td>
