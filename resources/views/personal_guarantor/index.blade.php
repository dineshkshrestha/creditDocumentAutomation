...
@endsection
@section('content')
    @include('modal.personal_guarantor_list_modal')
    <div class="box box-default">
        <div class="box-header with-border">
            <h3 class="box-title">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            <a href="{{route('personal_guarantor.personal_create',$bid)}}">
                                <i class="fa fa-male fa-fw"></i>Personal Guarantor</a>
                        </li>
                        <li>
                            <a href="{{route('personal_guarantor.corporate_create',$bid)}}">
            ...
            <span><a class="btn btn-info btn-xm pull-right"  href="{{route('personal_guarantor.proceed',$bid)}}"><i class="fa fa-save fa-fw"></i>Proceed to Property Selection </a></span>
                ...
                @foreach($personal_borrower as $a)
                    @if($a->status==1)
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-primary btn-xs" href="{{route('personal_guarantor.personal_borrower',[$bid,$a->id])}}">
                    ...
                    @if($a->status==1)
                        <tr>
                            ...
                            <td style="font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size: 14px;">{{$a->dob_day}}
                                ÷{{$a->dob_month}}÷{{$a->dob_year}}</td>
                            <td>
                                <a class=" btn btn-primary btn-xs" href="{{route('personal_guarantor.personal_select',[$bid,$a->id])}}">
                                    <i class="fa  fa-square-o fa-fw"></i>Select as Guarantor</a>
                            </td>
                    ...
                    @if($a->status==1)
                        <tr>
                            ...
                            <td style="font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size: 14px;">{{$a->dob_day}}
                                ÷{{$a->dob_month}}÷{{$a->dob_year}}</td>
                            <td>
                                <a class=" btn btn-primary btn-xs" href="{{route('personal_guarantor.personal_property_owner',[$bid,$a->id])}}">
                                    <i class="fa  fa-square-o fa-fw"></i>Select as Guarantor</a>
                            </td>
                    ...
                    @if($a->status==1)
                        <tr>
                            ...
                            <td style="font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size: 14px;">{{$a->reg_day}}
                             ...
                             <td>
                                <a class=" btn btn-primary btn-xs" href="{{route('personal_guarantor.corporate_borrower',[$bid,$a->id])}}">
                                    <i class="fa  fa-square-o fa-fw"></i>Select as Guarantor</a>
                            </td>
                    ...
                    @if($a->status==1)
                        <tr>
                            ...
                            <td style="font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size: 14px;">{{$a->reg_day}}
                                ÷{{$a->reg_month}}÷{{$a->reg_year}}</td>
                             <td>
                                <a class=" btn btn-primary btn-xs" href="{{route('personal_guarantor.corporate_select',[$bid,$a->id])}}">
                                    <i class="fa  fa-square-o fa-fw"></i>Select as Guarantor</a>
                            </td>
                ...
                @foreach($corporate_property_owner as $a)
                    @if($a->status==1)
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-primary btn-xs" href="{{route('personal_guarantor.corporate_property_owner',[$bid,$a->id])}}">
                                    <i class="fa  fa-square-o fa-fw"></i>Select as Guarantor</a>
                            </td>
