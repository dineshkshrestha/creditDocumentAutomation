...
@section('content')
    <div class="box box-default">
        ...
        <!-- /.box-header -->
        {!! Form::open(['route' => ['personal_guarantor.corporate_store',$bid],'method'=>'post','novalidate' => 'novalidate'],['class'=>'form-horizontal']) !!}
        ...
        <div class="box-body">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td style="padding-right: 12px">  {!! form::text('client_id','',['class'=>'form-control input-sm','id'=>'name','autocomplete'=>'off','required'=>'required','style'=>"width:250px; width:300px font-size:14px; "]) !!}
