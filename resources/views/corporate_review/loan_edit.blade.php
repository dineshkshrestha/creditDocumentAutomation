...
@section('breadcrumb')
    ...
    <li class="active"><strong>Edit Loan Details</strong></li>
...
$id=$loan->id;
@endphp
                {!! Form::open(['route' => ['corporate_review.loan_update',$id],'method'=>'post'],['class'=>'form-horizontal']) !!}
                ...
                {!! form::hidden('bid',$bid,[]) !!}
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="padding-right: 12px">  {!! form::text('amount',$amount,['placeholder'=>'Please enter loan amount.','class'=>'form-control input-sm ','id'=>'number','autocomplete'=>'off']) !!}
                ...
                <div class="box-footer">
                    ...
                    {!! Form::submit('Save',['class'=>'btn btn-primary pull-right','value'=>'Convert to word','onclick'=>'convert_no_to_words()']) !!}
                </div>
