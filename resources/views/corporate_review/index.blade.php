...
@section('content')
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            <h4 class="box-title">
                <span class="" style="color: #0a0a0a"><i class="fa fa-info-circle fa-fw"></i>Before Submitting, Please Check all the details of <b>{{App\CorporateBorrower::find($bid)->english_name}}</b>
           .
            </span></h4>
            <span><a class="btn btn-danger btn-xm pull-right" href="{{route('corporate_review.proceed',$bid)}}">
                            ...
                            <div id="borrower" class="panel-collapse collapse in">
                                <div class="box-body">
                                    <a class="btn btn-warning btn-xs pull-right"
                                       href={{route('corporate_review.borrower_edit',[$borrower->id])}}><i
                                    ...
                                    <table>
                                        ...
                                        @endphp
                                        <tr><Th colspan="2" style="color: orangered"><b><u>Authorized Person Details</u></b></Th></tr>
                                        <tr>
                                            <th style="padding-right: 8px; float: right; ">Name:</th>
                                            ...
                                            <div class="box-body">
                                                ...
                                                @foreach($corporate_guarantor as $c)
                                                    ...
                                                    <a href="" class="btn btn-danger btn-xs pull-right">
                                                        <form action="{{route('corporate_review.corporate_guarantor_destroy',[$bid,$c->id])}}"
                                                              method="post">
                                                            {{csrf_field()}}
                                                    ...
                                                    <a class="btn btn-warning btn-xs pull-right"
                                                       href={{route('corporate_review.corporate_guarantor_edit',[$bid,$c->id])}}><i
                                                                class="fa fa-edit"></i>Edit</a>
                                                    <table>
                                                        <tr>
                                                            <th style="padding-right: 8px; float: right; ">Name:</th>
                                                    ...
                                                    <table>
                                                        ...
                                                        @endphp
                                                        <tr><Th colspan="2" style="color: blue"><b><u>Authorized Person Details</u></b></Th></tr>
                                                        <tr>
                                                            <th style="padding-right: 8px; float: right; ">Name:</th>
                                                            <td style="font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px;">{{$b->nepali_name}}</td>
                                                            <td width="200"></td>
                                        ...
                                        <div id="personal_guarantor" class="panel-collapse collapse">
                                            <div class="box-body">
                                                ...
                                                @foreach($personal_guarantor as $b)
                                                    ...
                                                    <a href="" class="btn btn-danger btn-xs pull-right">
                                                        <form action="{{route('corporate_review.personal_guarantor_destroy',[$bid,$b->id])}}"
                                                              method="post">
                                                            {{csrf_field()}}
                                                            <input type="hidden" name="_method" value="delete">
                                                            <button type="submit" class="btn btn-danger btn-xs"
                                                    ...
                                                    <a class="btn btn-warning btn-xs pull-right"
                                                       href={{route('corporate_review.personal_guarantor_edit',[$bid,$b->id])}}><i
                                                                class="fa fa-edit"></i>Edit</a>
                                        ...
                                        <div id="personal_land_owner" class="panel-collapse collapse">
                                            <div class="box-body">
                                                ...
                                                @foreach($personal_land_owner as $plo)
                                                    ...
                                                    <a href="" class="btn btn-danger btn-xs pull-right">
                                                        <form action="{{route('corporate_review.personal_property_owner_destroy',[$bid,$plo->id])}}"
                                                              method="post">
                                                            {{csrf_field()}}
                                                            <input type="hidden" name="_method" value="delete">
                                                            <button type="submit" class="btn btn-danger btn-xs"
                                                    ...
                                                    <a class="btn btn-warning btn-xs pull-right"
                                                       href={{route('corporate_review.personal_property_owner_edit',[$bid,$plo->id])}}><i
                                                                class="fa fa-edit"></i>Edit</a>
                                                    <table>
                                                        <tr>
                                                            <th style="padding-right: 8px; float: right; ">Name:</th>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href=""
                                                                           class="btn btn-danger btn-xs pull-right">
                                                                            <form action="{{route('corporate_review.personal_land_destroy',[$bid,$land->id])}}"
                                                                                  method="post">
                                                                                {{csrf_field()}}
                                                                        ...
                                                                        <a class="btn btn-warning btn-xs pull-right"
                                                                           href={{route('corporate_review.personal_land_edit',[$bid,$land->id])}}><i
                                                                                    class="fa fa-edit"></i>Edit</a>
                                                            ...
                                                            @if($share->property_owner_id==$plo->id)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href=""
                                                                           class="btn btn-danger btn-xs pull-right">
                                                                            <form action="{{route('corporate_review.personal_share_destroy',[$bid,$share->id])}}"
                                                                                  method="post">
                                                                                {{csrf_field()}}
                                                                                <input type="hidden" name="_method"
                                                                                       value="delete">
                                                                        ...
                                                                        <a class="btn btn-warning btn-xs pull-right"
                                                                           href={{route('corporate_review.personal_share_edit',[$bid,$share->id])}}><i
                                                                                    class="fa fa-edit"></i>Edit</a>
                                        ...
                                        <div id="corporate_land_owner" class="panel-collapse collapse">
                                            <div class="box-body">
                                                ...
                                                @foreach($corporate_land_owner as $clo)
                                                    ...
                                                    <a href="" class="btn btn-danger btn-xs pull-right">
                                                        <form action="{{route('corporate_review.corporate_property_owner_destroy',[$bid,$clo->id])}}"
                                                              method="post">
                                                            {{csrf_field()}}
                                                            <input type="hidden" name="_method" value="delete">
                                                            <button type="submit" class="btn btn-danger btn-xs"
                                                    ...
                                                    <a class="btn btn-warning btn-xs pull-right"
                                                       href={{route('corporate_review.corporate_property_owner_edit',[$bid,$clo->id])}}><i
                                                                class="fa fa-edit"></i>Edit</a>
                                                    <table>
                                                        <tr>
                                                            <th style="padding-right: 8px; float: right; ">Name:</th>
  ...
  <td style="font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size: 14px;">{{$land->wardno}}</td>
																   ...
																   <td style="font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size: 14px;">{{$land->sheet_no}}</td>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href=""
                                                                           class="btn btn-danger btn-xs pull-right">
                                                                            <form action="{{route('corporate_review.corporate_land_destroy',[$bid,$land->id])}}"
                                                                                  method="post">
                                                                                {{csrf_field()}}
                                                                                <input type="hidden" name="_method"
                                                                                       value="delete">
                                                                        ...
                                                                        <a class="btn btn-warning btn-xs pull-right"
                                                                           href={{route('corporate_review.corporate_land_edit',[$bid,$land->id])}}><i
                                                                                    class="fa fa-edit"></i>Edit</a>
                                                            ...
                                                            @if($share->property_owner_id==$clo->id)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a href=""
                                                                           class="btn btn-danger btn-xs pull-right">
                                                                            <form action="{{route('corporate_review.corporate_share_destroy',[$bid,$share->id])}}"
                                                                                  method="post">
                                                                                {{csrf_field()}}
                                                                                <input type="hidden" name="_method"
                                                                                       value="delete">
                                                                        ...
                                                                        <a class="btn btn-warning btn-xs pull-right"
                                                                           href={{route('corporate_review.corporate_share_edit',[$bid,$share->id])}}><i
                                                                                    class="fa fa-edit"></i>Edit</a>
                                    ...
                                    @if($joint_property_owner)
                                        <div class="box-header with-border">
                                            ...
                                            <span>                                                        <a href=""
                                                                                                             class="btn btn-danger btn-xs pull-right">
                                                            <form action="{{route('corporate_review.joint_property_owner_destroy',[$bid])}}"
                                                                  method="post">
                                                                {{csrf_field()}}
                                                                <input type="hidden" name="_method" value="delete">
                                                                <button type="submit" class="btn btn-danger btn-xs"
                                                        ...
                                                        <table>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size:14px; ">
                                                                    ...
                                                                    {{$plo->issued_year}}÷{{$plo->issued_month}}÷{{$plo->issued_day}}</td>
                                                            </tr>
                                                            <tr>
                                                                <th style=" padding-right: 8px; float: right; ">Date of
                                                                    Birth:
  ...
  <td style="font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size: 14px;">{{$land->wardno}}</td>
														   ...
														   <td style="font-family:Bishallb,FONTASY_ HIMALI_ TT; font-size: 14px;">{{$land->sheet_no}}</td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href=""
                                                                   class="btn btn-danger btn-xs pull-right">
                                                                    <form action="{{route('corporate_review.joint_land_destroy',[$bid,$land->id])}}"
                                                                          method="post">
                                                                        {{csrf_field()}}
                                                                        <input type="hidden" name="_method"
                                                                               value="delete">
                                                                ...
                                                                <a class="btn btn-warning btn-xs pull-right"
                                                                   href={{route('corporate_review.joint_land_edit',[$bid,$land->id])}}><i
                                                                            class="fa fa-edit"></i>Edit</a>
                                    ...
                                    <table class="table table-striped table-bordered table-hover dataTables-example">
                                        ...
                                        @foreach($hirepurchase as $h)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="" class="btn btn-danger btn-xs pull-right">
                                                        <form action="{{route('corporate_review.hirepurchase_destroy',[$bid,$h->id])}}"
                                                              method="post">
                                                            {{csrf_field()}}
                                                            <input type="hidden" name="_method" value="delete">
                                                            <button type="submit" class="btn btn-danger btn-xs"
                                                    ...
                                                    <a class="btn btn-warning btn-xs pull-right"
                                                       href={{route('corporate_review.hirepurchase_edit',[$bid,$h->id])}}><i
                                                                class="fa fa-edit"></i>Edit</a>
...
@endif
                                ...
                                {{$f->tenure}}</span>
                                                ...
                                                <td>
                                                    <a href="" class="btn btn-danger btn-xs pull-right">
                                                        <form action="{{route('corporate_review.facilities_destroy',[$bid,$f->id])}}"
                                                              method="post">
                                                            {{csrf_field()}}
                                                            <input type="hidden" name="_method" value="delete">
                                                            <button type="submit" class="btn btn-danger btn-xs"
                                                    ...
                                                    <a class="btn btn-warning btn-xs pull-right"
                                                       href={{route('corporate_review.facilities_edit',[$bid,$f->id])}}><i
                                                                class="fa fa-edit"></i>Edit</a>
                        ...
                        <div class="panel box box-danger">
                            ...
                            <div id="loan" class="panel-collapse collapse">
                                <div class="box-body">
                                    ...
                                    <a class="btn btn-warning btn-xs pull-right"
                                       href={{route('corporate_review.loan_edit',[$bid,$loan->id])}}><i
                                                class="fa fa-edit"></i>Edit</a>
