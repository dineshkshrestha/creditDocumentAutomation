...
@section('breadcrumb')
    ...
    <li><a href="{{route('corporate_facilities.index',$bid)}}">Loan Details</a></li>
    <li><a href="{{route('corporate_review.index',$bid)}}">Review</a></li>
    <li class="active"><strong>Joint Land Edit</strong></li>
@endsection
...
@section('content')
    ...
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['corporate_review.joint_land_update',$land->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
