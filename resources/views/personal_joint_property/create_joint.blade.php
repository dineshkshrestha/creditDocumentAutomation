...
@section('content')
    ...
    <div class="box box-default">
        <div class="box-header with-border">
            ...
            <span><a class="btn btn-info btn-xm pull-right" href="{{route('personal_property_join.index',$bid)}}">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('personal_property_join.select',[$bid,$a->id])}}">
    ...
    {!! Form::open(['route' => 'personal_property_join.newstore','method'=>'post','novalidate' => 'novalidate'],['class'=>'form-horizontal']) !!}
