...
@section('breadcrumb')
    ...
    <li><a href="{{route('personal_property_join.owner_create',$bid)}}">Create Joint Owner</a></li>
...
@section('content')
            ...
            <h3 class="box-title">
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li>
                            <a href="{{route('personal_property_join.owner_create',$bid)}}">
                                <i class="fa fa-plus fa-fw"></i>
                                Add New Owner
                            </a>
                        </li>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a href="{{route('personal_property_join.land_edit',[$bid,$a->id])}}"
                                           class="btn-xs"> <i class="fa fa-pencil fa-fw"></i>Edit</a>
                                    </li>
                                    <li>
                                        <a href="">
                                            <form action="{{route('personal_property_join.land_destroy',[$bid,$a->id])}}"
                                                  method="post">
                                                {{csrf_field()}}
    ...
    {!! Form::open(['route' => 'personal_property_join.land_store','method'=>'post'],['class'=>'form-horizontal']) !!}
    ...
    @include('modal.personal_joint_view_modal')
