...
@section('small_heading','Please Edit the Property')
@section('borrower')
...
@section('breadcrumb')
    ...
    <li><a href="{{route('personal_property_join.index',$bid)}}">Joint Owner</a></li>
    <li class="active"><strong>Joint Property Edit</strong></li>
@endsection
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['personal_property_join.land_update',$land->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
                <input type="hidden" name="_method" value="put">
                <input type="hidden" name="pid" value="{{$land->id}}">
