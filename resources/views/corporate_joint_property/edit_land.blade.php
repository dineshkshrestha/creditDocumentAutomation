...
@section('heading','Edit Joint Property')
...
@section('breadcrumb')
    ...
    <li><a href="{{route('corporate_property.index',$bid)}}">Corporate P.O.</a></li>
    <li><a href="{{route('corporate_property_join.index',$bid)}}">Joint P.O.</a></li>
...
@section('content')
    <div class="col-md-10">
        <div class="box box-default ">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                {!! Form::open(['route' =>['corporate_property_join.land_update',$land->id],'method'=>'post','novalidate'=>'novalidate','class'=>'form-horizontal','enctype'=>'multipart/form-data']) !!}
