...
@section('title',' Submitted List ')
@section('heading','Submitted')
@section('small_heading','List')
@section('breadcrumb')
    <li><a href="{{route('home')}}">Dashboard</a></li>
    <li class="active"><strong>Submitted List</strong></li>
            ...
            <table id="permission" class="table table-striped table-bordered table-hover dataTables-example">
                ...
                @foreach($psubmitted as $a)
                    <tr>
                        ...
                        <td>{{\App\User::find($a->submitted_by)->name}}</td>
                        <td>Individual</td>
                    </tr>
                @endforeach
