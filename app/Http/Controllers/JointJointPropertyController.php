...
class JointJointPropertyController extends Controller
{
    /**
...
//    `   district
        ...
        if ($joint) {
            ...
            if ($joint1 && $joint2 && $joint3) {
                ...
                return view('joint_joint_property.create_joint', compact('bid', 'district', 'localbody', 'property_owner', 'jid', 'joint'));
            }


        } else {
            Session::flash('warning', 'Please Add More joint property owners.');
            return view('joint_joint_property.create_joint', compact('bid', 'district', 'localbody', 'property_owner', 'jid'));
        }


        return view('joint_joint_property.index', compact('bid', 'district', 'localbody', 'jid', 'joint1', 'joint2', 'joint3', 'land', 'property_owner'));
    }
...
//        getting id of inserted data
        ...
        return redirect()->route('joint_property_personal.index', compact('bid'));
    }
    ...
    public function remove($bid, $jid, $poid)
    {
        ...
        return redirect()->route('joint_property_personal.owner_create', compact('bid'));
...
//    `   district
    ...
    public function land_edit($bid, $pid)
    {
        ...
        return view('joint_joint_property.edit_land', compact('bid', 'land', 'localbody', 'district'));
    ...
    public function land_update(JointLandUpdateRequest $request)
    {
        ...
        if ($result) {
            ...
            return redirect()->route('joint_property_personal.land_edit', compact('bid', 'pid'));
        }
        return redirect()->route('joint_property_personal.index', compact('bid'));
    }
