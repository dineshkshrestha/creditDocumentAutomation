...
class CorporateFacilitiesController extends Controller
{
    ...
    public function index($bid)
    {
        ...
        return view('corporate_facilities.index', compact('bid', 'facilities', 'facility', 'loan', 'branch', 'total'));
    }
    ...
    public function store(Request $request)
    {
        ...
        function Dinesh_money_format($money)
        {
            ...
            if ($amount && $rate) {
                ...
                $result = CorporateFacilities::create([
    ...
    public function edit($bid, $id)
    {
        ...
        return view('corporate_facilities.edit_facilities', compact('bid', 'facility', 'facilities','a'));
    ...
    public function update(PersonalFacilityUpdateRequest $request, $id)
    {
        ...
        if ($result) {
            ...
            return redirect()->route('corporate_facilities.edit', compact('bid', 'id'));
