...
class PersonalJointPropertyController extends Controller
{
    /**
...
//    `   district
        ...
        if ($joint) {
            ...
            if ($joint1 && $joint2 && $joint3) {
                ...
                return view('personal_joint_property.create_joint', compact('bid', 'district', 'localbody', 'property_owner', 'jid', 'joint'));
            }


        } else {
            Session::flash('warning', 'Please Add More joint property owners.');
            return view('personal_joint_property.create_joint', compact('bid', 'district', 'localbody', 'property_owner', 'jid'));
        }


        return view('personal_joint_property.index', compact('bid', 'district', 'localbody', 'jid', 'joint1', 'joint2', 'joint3', 'land', 'property_owner'));
    }
...
//        getting id of inserted data
        ...
        return redirect()->route('personal_property_join.index', compact('bid'));
    }
    ...
    public function remove($bid, $jid, $poid)
    {
        ...
        return redirect()->route('personal_property_join.owner_create', compact('bid'));
...
//    `   district
    ...
    public function land_edit($bid, $pid)
    {
        ...
        return view('personal_joint_property.edit_land', compact('bid', 'land', 'localbody', 'district'));
    ...
    public function land_update(JointLandUpdateRequest $request)
    {
        ...
        if ($result) {
            ...
            return redirect()->route('personal_property_join.land_edit', compact('bid', 'pid'));
        }
        return redirect()->route('personal_property_join.index', compact('bid'));
    }
