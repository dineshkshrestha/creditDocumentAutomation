...
use App\Http\Requests\CorporateLoanUpdateRequest;
...
class CorporateReviewController extends Controller
{
...
//loan
        ...
        return view('corporate_review.index', compact('jointp', 'joint_property_owner', 'corporate_share_owner', 'corporate_land_owner', 'cyear', 'personal_share_owner', 'bid', 'borrower', 'corporate_guarantor', 'personal_guarantor', 'facilities', 'loan', 'personal_land_owner', 'hirepurchase'));
    }
    ...
    public function borrower_edit($id)
    {
        ...
        $bid = $id;
        return view('corporate_review.edit', compact('borrower','bid','id', 'authorized_person', 'department', 'ministry', 'localbody', 'district'));


    }


    public function borrower_update(CorporateUpdateRequest $request, $id)
    {
        $bid = $request->input('bid');
        $guarantor = CorporateBorrower::find($id);
        ...
        return redirect()->route('corporate_review.index', compact('bid'));
    ...
    public function personal_guarantor_edit($bid, $id)
    {
        ...
        return view('corporate_review.personal_guarantor_edit', compact('guarantor', 'district', 'localbody', 'bid'));
    ...
    public function personal_guarantor_destroy($bid, $id)
    {
        ...
        $personal_guarantor = CorporateGuarantorBorrower::where([
            ['borrower_id', $bid],
...
$status=null;
    ...
    public function corporate_guarantor_edit($bid, $id)
    {
        ...
        return view('corporate_review.corporate_guarantor_edit', compact('guarantor', 'bid', 'authorized_person', 'department', 'ministry', 'localbody', 'district'));
    ...
    {
        $corporate_guarantor = CorporateGuarantorBorrower::where([
            ['borrower_id', $bid],
...
$status=null;
    ...
    public function personal_property_owner_edit($bid, $id)
    {
        ...
        return view('corporate_review.personal_property_owner_edit', compact('property_owner', 'district', 'localbody', 'bid'));
    ...
    public function personal_property_owner_destroy($bid, $id)
    {
        ...
        foreach ($personal_land as $po) {
            $land = CorporateLandBorrower::where([['borrower_id', $bid],
        ...
        foreach ($personal_share as $po) {
            $share = CorporateShareBorrower::where([['borrower_id', $bid],
    ...
    public function corporate_property_owner_edit($bid, $id)
    {
        ...
        return view('corporate_review.corporate_property_owner_edit', compact('bid', 'property_owner', 'authorized_person', 'department', 'ministry', 'localbody', 'district'));
    }
    ...
    public function facilities_edit($bid, $id)
    {
        ...
        $facility = CorporateFacilities::find($id);
        return view('corporate_review.facilities_edit', compact('facility', 'facilities', 'bid'));
    ...
    public function loan_edit($bid, $id)
    {
        ...
        return view('corporate_review.loan_edit', compact('loan', 'facility', 'bid', 'branch', 'amount'));

    }

    public function loan_update(CorporateLoanUpdateRequest $request, $id)
    {
        $bid = $request->get('bid');
    ...
    public function hirepurchase_edit($bid, $id)
    {
        ...
        return view('corporate_review.edit_vehicle', compact('bid', 'vehicle'));
    }
    ...
    public function personal_land_edit($bid, $id)
    {
        ...
        return view('corporate_review.edit_land', compact('bid', 'land', 'localbody', 'district'));
    ...
    public function personal_land_update(LandUpdateRequest $request, $id)
    {
        ...
        if ($result) {
            ...
            return redirect()->route('corporate_review.land_edit', compact('bid', 'id'));
        }
        return redirect()->route('corporate_review.index', compact('bid'));
    }
    ...
    {
        $land = CorporateLandBorrower::where([['personal_land_id', $id], ['borrower_id', $bid]])->first();
       $result=null;
        try {
            $result = $land->delete();
    ...
    public function personal_share_edit($bid, $id)
    {
        ...
        return view('corporate_review.edit_share', compact('bid', 'isin', 'share'));
    }
...
//dd($request);
        ...
        if ($result) {
            ...
            return redirect()->route('corporate_reviewy.share_edit', compact('bid'));
        }
        return redirect()->route('corporate_review.index', compact('bid'));
    ...
    {
        $land = CorporateShareBorrower::where([['personal_share_id', $id], ['borrower_id', $bid]])->first();
$result=null;
        try {
            $result = $land->delete();
    ...
    public function corporate_land_edit($bid, $id)
    {
        ...
        return view('corporate_review.edit_corporate_land', compact('bid', 'land', 'localbody', 'district'));
    ...
    {
        $land = CorporateLandBorrower::where([['corporate_land_id', $id], ['borrower_id', $bid]])->first();
        $result=null;
        try {
            $result = $land->delete();
    ...
    public function corporate_share_edit($bid, $id)
    {
        ...
        return view('corporate_review.edit_corporate_share', compact('bid', 'isin', 'share'));
    }
...
//dd($request);
    ...
    {
        $land = CorporateShareBorrower::where([['corporate_share_id', $id], ['borrower_id', $bid]])->first();
        $result=null;
        try {
            $result = $land->delete();
    ...
    public function joint_land_edit($bid, $id)
    {
        ...
        return view('corporate_review.edit_joint_land', compact('bid', 'land', 'localbody', 'district'));
    ...
    public function joint_land_update(LandUpdateRequest $request, $id)
    {
        ...
        if ($result) {
            ...
            Session::flash('danger', 'Failed to Edit Land');
            return redirect()->route('corporate_review.edit_joint_land', compact('bid', 'id'));
        }
        return redirect()->route('corporate_review.index', compact('bid'));
    }
