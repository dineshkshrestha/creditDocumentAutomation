...
class CorporateGuarantorUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'registration_number'=>'required|max:20|unique:tbl_corporate_guarantor,registration_number,'.$this->id,
