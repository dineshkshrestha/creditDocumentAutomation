...
class CorporateUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'registration_number' => 'required|max:20|unique:tbl_corporate_borrower,registration_number,' . $this->id,
    ...
    public function messages()
    {
        return [
            ...
            'a_issued_year.min' => 'ISSUED YEAR MUST BE MORE THAN 18 YEARS FROM DATE OF BIRTH',
            ...
            'a_citizenship_number.unique' => 'CITIZENSHIP NUMBER SHOULD BE UNIQUE',
