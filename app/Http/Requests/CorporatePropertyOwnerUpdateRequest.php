...
class CorporatePropertyOwnerUpdateRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        return [
            ...
            'registration_number' => 'required|max:20|unique:tbl_corporate_property_owner,registration_number,' . $this->id,
