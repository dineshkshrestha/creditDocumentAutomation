...
class CreateTblPersonalBorrowerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_personal_borrower', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('joint_id')->nullable();
    ...
    {
        Schema::dropIfExists('tbl_personal_borrower');
    }
}
