...
class CreateTblPersonalLandBorrowerTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbl_personal_land_borrower', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('tbl_personal_land_borrower');
    }
}
